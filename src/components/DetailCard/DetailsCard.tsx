      ...
      <div className="flex flex-col  gap-1 p-2">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="md:flex md:gap-3 text-nowrap">
            ...
            <p className="text-gray-700">
              {details?.Result?.LockOrMint?.lastUpdateLimit} {details?.token}
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="md:flex md:gap-3 text-nowrap">
            ...
            <p className="text-gray-700">
              {details?.Result?.UnlockOrBurn?.currentLimit} {details?.token}
            </p>
          </div>
          <div className="md:flex md:gap-3 text-nowrap">
            <p className="font-semibold">Max limit :</p>
            <p className="text-gray-700">
              {details?.Result?.UnlockOrBurn?.maxLimit} {details?.token}
            </p>
          </div>
          <div className="md:flex md:gap-3 text-nowrap">
          ...
          <div className="md:flex md:gap-3 text-nowrap">
            <p className="font-semibold">Last Update Limit :</p>
            <p className="text-gray-700">
              {details?.Result?.UnlockOrBurn?.lastUpdateLimit} {details?.token}
            </p>
          </div>
        </div>
      </div>
